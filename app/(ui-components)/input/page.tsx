    ...
    <div className="flex flex-col mt-6 py-14 px-16 text-gray-200">
      ...
      >
        ...
        <p className="text-base">
          ...
          ingresar datos en un formulario (como nombre, correo, contraseña,
          etc.). Este Input es flexible y configurable: podés usarlo en
          distintos lugares y con distintos comportamientos, sin tener que
          volver a escribir el mismo HTML, estilos o lógica. Ejemplo: lo usás
          una vez para un campo de email, otra para contraseña, otra para
          nombre, etc. Solo cambiás las props, y el componente se adapta. Lo que
          hace especial a este componente es que:
        </p>
        <ul className="bullet">
          <li>
        ...
        <CodeBlock code={code} language="tsx" height={900} />
        <h2 className="title-lg">Explicación de cada prop (propiedad)</h2>
        <p className="text-base leading-8">
          <span className="highlight">label?: string;</span> Texto opcional que
          aparece arriba del input
          <br />
          <span className="highlight">classNameLabel?: string;</span> Estilo del
          label.
          <br />
          <span className="highlight">name: string;</span> Identificador del
          campo (para HTML y formularios)
          <br />
          <span className="highlight">type?: string;</span>
          {'  Tipo de input: "text";`, "email", "password"'}, etc.
          <br />
          <span className="highlight">placeholder?: string;</span> Texto gris
          que aparece dentro del input como ayuda
          <br />
          <span className="highlight">value?: string;</span> Valor actual del
          input (se usa en formularios controlados)
          <br />
          ...
          <br />
          <span className="highlight">className?: string;</span> Clases CSS
          extra que quieras agregar
          <br />
          <span className="highlight">disabled?: boolean;</span> Si está
          deshabilitado (no se puede escribir)
          <br />
          <span className="highlight">required?: boolean;</span> Si es
          obligatorio llenarlo
        </p>
        <p className="text-base">
          Todas las props con ? son opcionales (no es obligatorio pasarlas).
          Solo name es requerida.
        </p>
        ...
        <ul className="bullet">
          ...
          <li>
            El className combina los estilos base con los personalizados que
            podés pasar externamente.
          </li>
        </ul>
        ...
        <p className="text-base">
          Podés agregar la clase className para personalizarlo. Lo que agregues
          aquí se superpone a los valores ya declarados. Eso es lo bueno de
          Tailwindcss, es muy flexible.
          <br />
          Ejemplo:<span className="highlight">className={'"border-red-500 bg-yellow-200"'}</span> 
        </p>
      </motion.div>
    </div>
  );
