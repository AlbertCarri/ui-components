...
export default function Page() {
  ...
  return (
    <div className="flex flex-col mt-6 py-14 px-16 text-gray-200 ">
      ...
      >
        <h1 className="title-xl">Button reutilizable usando TypeScript</h1>
        <p className="text-base">
          Un componente es reutilizable cuando puede usarse en múltiples partes
          de una aplicación sin necesidad de duplicar lógica ni estructura. En
          este caso, podés usar {"<Button>"} en cualquier parte del proyecto, ya
          que:
        </p>
        <ul className="bullet">
          <li>
          ...
          <li>
            Maneja su tipo (type) para funcionar como submit, reset o button
            según el formulario donde se use.
          </li>
          <li>
        ...
        <h2 className="title-lg">2. Propiedades (props) bien definidas</h2>
        <p className="text-base">
        ...
        <ul className="bullet">
          <li>
            children: lo que se renderiza dentro del botón (texto, íconos,
            etc.).
          </li>
          ...
          <li>
            className: permite modificar estilos desde afuera sin romper el
            diseño base.
          </li>
        </ul>
        ...
        <Button
          type="button"
          onClick={() => alert("Hiciste click!!!")}
          className="mx-auto mt-8 bg-blue-700 text-blue-100 hover:bg-blue-900"
        >
          Button
        </Button>
        </div>
